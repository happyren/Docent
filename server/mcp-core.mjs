...
export const TOOLS = [
  ...
  },
  {
    ...
    name: "find_symbol",
    description:
      "Find a library symbol by name or meaning — 'lambda', 'queue', 'postgres', 'cdn' — in the bundled icon libraries (AWS architecture icons, software architecture). Answers ranked matches with id, name, library, category and size; pass the id as `symbol` to add_node.\nExample: find_symbol({query:'queue'}) → [{symbol:'aws/sqs', name:'SQS', …}]",
    inputSchema: {
      type: "object",
      properties: {
